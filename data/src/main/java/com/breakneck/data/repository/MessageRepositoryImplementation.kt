...
class MessageRepositoryImplementation(private val networkStorage: NetworkStorage, private val  databaseStorage: DatabaseStorage): MessageRepository {
    ...
    override fun saveSentMessage(message: Message) {
        databaseStorage.saveSentMessage(message = MessageData(cellNumber = message.cellNumber, text = message.text))
    }
