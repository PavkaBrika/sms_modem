...
const val SHARED_PREFERENCES_NAME = "SETTINGS_SHARED_PREFERENCES"
const val PORT = "PORT"

class SettingsSharedPreference(private val context: Context): SettingsStorage {

    private val sharedPreference = context.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE)
